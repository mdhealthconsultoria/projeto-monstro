const CACHE_NAME = 'skeelo-cache-v16';
const PRECACHE_URLS = [
  './',
  './index.html',
  './manifest.json',
  ...
  './js/views/focus.js',
  './js/views/saude.js',
  './js/views/jornada90.js',
  './js/views/valueScore.js',
  './js/views/conhecimento.js',
  './js/views/ajuda.js',
  './js/views/notificacoes.js',
  './js/notifications.js',
  './js/services/photosCloud.js',
  './js/habitLibrary.js',
  './js/businessLibrary.js',
  './icons/icon-192.png',
  './icons/icon-512.png',
